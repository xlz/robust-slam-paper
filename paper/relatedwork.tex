...
\cj{Is the next sentence necessary? xlz: no.}
...
\cj{comment: use ' \~ ' to bind citations to text such that they are on the same line. xlz: will manually fix it when seeing more}
...
the robustness provided by previous techniques. \cj{Can we discuss why this next statement is true? xlz: It should be true by definition. This looks clarified?} Further, an observation-based
