...
\cj{Is the next sentence necessary?}
...
\cj{comment: use ' \~ ' to bind citations to text such that they are on the same line}
...
the robustness provided by previous techniques.  \cj{Can we discuss why this next statement is true?}  Further, observation-based
