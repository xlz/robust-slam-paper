...
\cj{if space permits, maybe a description of the stacking should be added? xlz: it will be very verbose cjenkins:understood.  this is not very important to the main contribution of the paper.  however, $A$, $b$, $\delta x$, and $\delta l$ appear and are used without much intuition for the reader.  Maybe a few more details can be given, such as the specific size of A and the fact that b is the residual error.  I also believe this stacking is covered in the iSAM paper, which could be cited.  Also, I am worried a reader could get hung up on the specific definition of ``stacking''.  So, maybe another choice of word could be used.}
