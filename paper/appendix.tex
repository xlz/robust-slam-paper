...
\end{equation}
where $I$ is the identity, %resolved\cj{does $I$ refer to the matrix identity? define xlz: yes}
\begin{equation*}
\begin{aligned}
...
\cj{if space permits, maybe a description of the stacking should be added?}
