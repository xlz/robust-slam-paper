...
keypoint depth implemented with OpenCV~\cite{opencv} and ROS~\cite{ros}.\cj{do you have a citation for this pipeline? or some implementation detail, like a C++ implementation using OpenCV libararies? xlz: citations add, but how to cite OpenCV?}  Due to lack of visual detection of loop closure, we also add
